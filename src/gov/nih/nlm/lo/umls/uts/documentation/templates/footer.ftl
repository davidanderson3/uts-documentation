	...
	<p class = "white"><#if (content.updated)??><b>Content last updated:</b> ${content.updated}</#if>
        <br/>
        <a href="http://www.nlm.nih.gov/copyright.html">Copyright</a>, <a href="http://www.nlm.nih.gov/privacy.html">Privacy</a>, <a href="http://www.nlm.nih.gov/accessibility.html">Accessibility</a>, <a href="/sitemap.html">Site Map</a>, <a href="/plugins.html">Viewers and Players</a>
        <br />
