  ...
  <header>
    <div class="container-fluid  bg-primary">
      <div class="container top_row">
        <div class="row">
          <div class="col"> <a href="https://www.hhs.gov/" class="text-white"><img src="https://wwwqa.nlm.nih.gov/images/HHS_White.png" class="hhslogo float-left img-fluid d-none d-sm-block"  alt="HHS logo"/>
    ...
    <div class="container-fluid">
      <div class="container branding">
        <div class="row">
          <div class="col-xl-1 col-md-1 col-2 my-md-2 mt-3 pt-md-1 pt-lg-0 pr-0"><a href="https://www.nih.gov/"><img src="https://wwwqa.nlm.nih.gov/images/NIH_Black.png" class="nih_logo img-fluid" alt="NIH logo"/></a> </div>
          ...
          <div class="col-lg-3 col-md-3">
            <ul class="list-inline mt-xl-3 mt-md-3 mt-3 social_media d-none d-sm-block   float-right">
              <li class="list-inline-item"><a href="https://www.facebook.com/nationallibraryofmedicine"><img class="img-fluid" src="https://wwwqa.nlm.nih.gov/images/Facebook_B.svg" alt="Facebook"/></a></li>
              <li class="list-inline-item"><a href="https://twitter.com/nlm_news"><img class="img-fluid" src="https://wwwqa.nlm.nih.gov/images/Twitter_B.svg" alt="Twitter"/></a></li>
              <li class="list-inline-item"><a href="https://www.youtube.com/user/NLMNIH"><img class="img-fluid" src="https://wwwqa.nlm.nih.gov/images/YouTube_B.svg" alt="YouTube"/></a></li>
            </ul>
          </div>
